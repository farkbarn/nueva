...
function exclude_categoria(){
 ...
 foreach((get_the_category()) as $category)
  {
   if($category->cat_name!="IMPRESO" and
$category->cat_name!="CLASIFICADOS" and 
$category->cat_name!="SIN CATEGORIA" and 
$category->cat_name!="SIN CATEGORIA" and 
$category->cat_name!="SIN-CATEGORIA" and 
$category->cat_name!="ASIVAN" and
$category->cat_name!="IMPRESO" and 
$category->cat_name!="GUARITOS-PAPEL" and 
$category->cat_name!="GUAREANDO" and 
$category->cat_name!="ESTAMPAS" and 
$category->cat_name!="ESPECIALES" and 
$category->cat_name!="CLASIFICADOS" and 
$category->cat_name!="SILUETA" and 
$category->cat_name!="DESTACADA" and 
$category->cat_name!="COLUMNA1A" and 
$category->cat_name!="COLUMNA2A" and 
$category->cat_name!="COLUMNA3A" and 
$category->cat_name!="COLUMNA1B" and 
$category->cat_name!="COLUMNA2B" and 
$category->cat_name!="COLUMNA3B" and 
$category->cat_name!="COLUMNA1B" and 
$category->cat_name!="COLUMNA2B" and 
$category->cat_name!="COLUMNA3B" and 
$category->cat_name!="DEPORTE COLUMNA1" and 
$category->cat_name!="DEPORTE COLUMNA2" and 
$category->cat_name!="DEPORTE DESTACADA" and 
...
$category->cat_name=="SIN CATEGORIA"  ||
